...
class UpdvdOrg(SimpleScraperBase):
    BASE_URL = 'http://updvd.org'
    OTHER_URLS = []
    ...
    def _fetch_no_results_text(self):
        return u'Lo siento, pero no se ha encontrado ninguna coincidencia'
    ...
    def _parse_search_result_page(self, soup):
        for result in soup.select('div[class="post search-page"]'):
