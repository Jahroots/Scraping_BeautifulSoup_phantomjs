...
class StreamingSerieCo(SimpleScraperBase):
    BASE_URL = 'http://www.streamania.xyz'
    OTHER_URLS = ['http://planet-streaming.xyz', 'http://zone-streaming.pro', 'http://streaming-serie.me', 'http://streaming-serie.co']
    ...
    def _fetch_no_results_text(self):
        return u"Désolé, mais vous n'avez pas le film"
