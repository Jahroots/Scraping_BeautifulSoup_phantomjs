...
class SineturkCo(SimpleScraperBase):
    BASE_URL = 'https://www.sineturk.co'
    OTHER_URLS = ['http://www.sineturk.co']
    ...
    def _fetch_next_button(self, soup):
        next_button = soup.find('a', text=u'İleri »')
        if next_button:
    ...
    def _parse_parse_page(self, soup):
        ...
        iframes = soup.select('div.postTabs_divs iframe')
