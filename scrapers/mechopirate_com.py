...
class MechoPirateCom(CloudFlareDDOSProtectionMixin, CachedCookieSessionsMixin, SimpleScraperBase):
    BASE_URL =  'https://www.mechopirate.com'

    OTHER_URLS = ["http://www.mechopirate.com"]
    ...
    def get(self, url, **kwargs):
        return super(MechoPirateCom, self).get(url, allowed_errors_codes=[403,], **kwargs)
