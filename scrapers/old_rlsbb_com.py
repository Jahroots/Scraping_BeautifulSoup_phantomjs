...
class OldRlsbbCom(SimpleScraperBase):
    BASE_URL = 'http://old.rlsbb.com'
    SEARCH_URL = 'http://search.rlsbb.com'

    OTHER_URLS = ['http://rlsbb.com', SEARCH_URL, 'http://rlsbb.ru' ]
    SINGLE_RESULTS_PAGE = True


    def setup(self):
        raise NotImplementedError('Duplicated of OldRlsbbCom')
        ...
        # This will happily go for thousands of pages, with history back
        # before 2010
        # Just grab the first 10 pages.
