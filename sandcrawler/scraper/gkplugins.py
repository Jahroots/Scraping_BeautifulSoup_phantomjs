...
class decrypter:
    def __init__(self, param1, param2):
        ...
        self.Rcon = [1, 2, 4, 8, 16, 32, 64, 128, 27, 54, 108, 216, 171, 77, 154, 47, 94, 188, 99, 198, 151, 53, 106,
        ...
        self.SBoxInverse = [82, 9, 106, 213, 48, 54, 165, 56, 191, 64, 163, 158, 129, 243, 215, 251, 124, 227, 57, 130,
        ...
        self.roundsArray = [0, 0, 0, 0, [0, 0, 0, 0, 10, 0, 12, 0, 14], 0, [0, 0, 0, 0, 12, 0, 12, 0, 14], 0,
    ...
    def keyExpansion(self, param1):
        ...
        while _loc4_ < self.Nk:
            if (_loc4_) < len(param1) / 4:
                _loc3_[_loc4_] = param1[4 * _loc4_] | param1[4 * _loc4_ + 1] << 8 | param1[4 * _loc4_ + 2] << 16 | \
                                 param1[4 * _loc4_ + 3] << 24
            _loc4_ += 1
        _loc4_ = self.Nk
        while _loc4_ < self.Nb * (self.Nr + 1):
            _loc2_ = _loc3_[_loc4_ - 1]
            if (_loc4_ % self.Nk == 0):
                _loc2_ = (self.SBox[_loc2_ >> 8 & 255] | self.SBox[_loc2_ >> 16 & 255] << 8 | self.SBox[
                    _loc2_ >> 24 & 255] << 16 | self.SBox[_loc2_ & 255] << 24) ^ self.Rcon[
                             int(math.floor(_loc4_ / self.Nk)) - 1]
            else:
                if (self.Nk > 6 and _loc4_ % self.Nk == 4):
                    _loc2_ = self.SBox[_loc2_ >> 24 & 255] << 24 | self.SBox[_loc2_ >> 16 & 255] << 16 | self.SBox[
                                                                                                             _loc2_ >> 8 & 255] << 8 | \
                             self.SBox[_loc2_ & 255]
            ...
            while (_loc4_ < 4):
                ...
                if (param2 == "encrypt"):
                    _loc3_[_loc4_] = self.mult_GF256(param1[_loc4_][_loc5_], 2) ^ self.mult_GF256(
                        param1[(_loc4_ + 1) % 4][_loc5_], 3) ^ param1[(_loc4_ + 2) % 4][_loc5_] ^ \
                                     param1[(_loc4_ + 3) % 4][_loc5_]
                else:
                    _loc3_[_loc4_] = self.mult_GF256(param1[_loc4_][_loc5_], 14) ^ self.mult_GF256(
                        param1[(_loc4_ + 1) % 4][_loc5_], 11) ^ self.mult_GF256(param1[(_loc4_ + 2) % 4][_loc5_],
                                                                                13) ^ self.mult_GF256(
                        param1[(_loc4_ + 3) % 4][_loc5_], 9)
                _loc4_ += 1
...
if __name__=='__main__':
    ...
    def decryptKey(param1):
        _local_2 = decrypter(198, 128)
        _local_3 = [17536, 16512, 16524, 17420, 17544, 3144, 3204, 17416, 19532, 3080, 16456, 16460, 18572, 16396, 19468,
                    17408, 19464, 16524, 18508, 17420]
        _local_4 = bytearray()
        _local_5 = 0
        _local_6 = 0
    ...
    print decryptKey('')
